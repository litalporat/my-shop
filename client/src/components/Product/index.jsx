...
const Index = props => {
    ...
    return (
        <div className="container">
            ...
            onMouseOver={(e) => e.target.style.backgroundImage =  `url(${props.product.images.display[1]})` }
            onMouseLeave={(e) => e.target.style.backgroundImage =  `url(${props.product.images.display[0]})` }
            />
